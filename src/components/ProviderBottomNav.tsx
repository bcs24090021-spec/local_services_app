import { LayoutDashboard, Briefcase, MessageSquare, Calendar, User } from 'lucide-react';
...
export function ProviderBottomNav({ activeTab, onTabChange }: ProviderBottomNavProps) {
